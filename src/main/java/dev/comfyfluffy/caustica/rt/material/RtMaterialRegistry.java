...
public final class RtMaterialRegistry {
    ...
    public static final class Snapshot {
        ...
        /**
         * Generic untextured thin-dielectric material used by coarse geometry sources such as
         * Distant Horizons, which preserve vertex colour/alpha but do not expose a Minecraft sprite.
         */
        public int glassId() {
        ...
        /** Generic untextured opaque emitter for coarse geometry that has no atlas sprite identity. */
        public int emissiveId() {
            return fallbackVariants[index(RtMaterials.Profile.DEFAULT, false, true)];
        }

        /** Generic untextured emitting dielectric for illuminated transparent DH geometry. */
